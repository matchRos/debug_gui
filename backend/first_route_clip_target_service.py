...
from cable_routing.debug_gui.backend.clip_types import (
    CLIP_TYPE_C_CLIP,
    CLIP_TYPE_PEG,
    CLIP_TYPE_U_CLIP,
)
from cable_routing.debug_gui.motion_primitives.c_clip import build_c_clip_entry_pixels
from cable_routing.debug_gui.motion_primitives.u_clip import build_u_clip_entry_pixels
